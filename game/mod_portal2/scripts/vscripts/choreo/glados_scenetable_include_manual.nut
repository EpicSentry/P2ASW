...
// ====================================== Turrets deployed scene
		...
		*/
		...
		SceneTable["-750_05"] <- {vcd=CreateSceneEntity("scenes/npc/sphere03/sp_a2_wheatley_ows20.vcd"),postdelay=0.0,next=null,char="glados",noDingOff=true,noDingOn=true,talkover=true,idlegroup="wheatleybouncepain",idleorderingroup=5}
...
// ****************************************************************************************************
if (curMapName=="sp_a1_intro1" || curMapName=="sp_a1_intro1_no_sound" )
{
	//Hello?
	SceneTable["-600_01"] <- 
	{
...
{
	if (!sp_a1_intro1_vault_started)
	{
		if (sp_a1_intro_cognitive_gauntlet_said)
		{
			nuke()
			GladosPlayVcd(360)
		}	
