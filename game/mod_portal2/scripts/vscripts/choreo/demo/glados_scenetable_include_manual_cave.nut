...
//SCENE: "Welcome, gentlemen, to Aperture Science..."
	if (curMapName=="demo_underground")
	{
...
if (curMapName=="sp_a3_bomb_flings")
	{
		...
		SceneTable ["-1957_01" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_lake_abyss01.vcd") 
		char = "cave"
		postdelay = 1.0
		predelay = 0.0
		next = "-1957_02"
		...
		SceneTable ["-1957_02" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_lake_abyss02.vcd") 
		char = "cave"
		postdelay = 0.1
		predelay = 0.0
		next = "-1957_03"
		...
		SceneTable ["-1957_03" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_lake_abyss06.vcd") 
		char = "cave"
		postdelay = 1.2
		predelay = 0.0
		next = "-1957_04"
		...
		SceneTable ["-1957_04" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_lake_abyss04.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = null
...
if (curMapName=="sp_a3_crazy_box")
	{	
		...
		SceneTable ["-1960_01" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_fourth_test_intro02.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = null
		...
		SceneTable ["-1963_01" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_fifth_test_complete01.vcd") 
		char = "cave"
		postdelay = 0.2
		predelay = 0.0
		next = "-1963_02"
		...
		SceneTable ["-1963_03" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_fifth_test_complete04.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1963_04"
		...
		SceneTable ["-1963_04" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_fifth_test_complete07.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = null
...
if (curMapName=="sp_a3_transition01")
	{
		...
		// Congratulations! The simple fact that you’re standing here listening to me means you’ve made a glorious contribution to science. We're going to take your picture, so stand there and smile.
		SceneTable ["-1964_01" ] <-
		{
		...
		SceneTable ["-1964_01a" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_outro03.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1964_02"
...
/*		
		...
		SceneTable ["-1964_01" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_outro04.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1964_02"
...
*/
		...
		SceneTable ["-1964_03" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/fifties_outro06.vcd") 
		char = "cave"
		postdelay = 0.2
		predelay = 0.0
		next = "-1964_04"
...
if (curMapName=="sp_a3_speed_ramp")
	{
		...
		SceneTable ["-1975_01" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_test_b_intro01.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1975_02"
		...
		SceneTable ["-1975_02" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_test_b_intro02.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1975_03"
		...
		SceneTable ["-1975_03" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_test_b_intro03.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = null
	...
	// Great job, astronaut, war hero and/or Olympian! With your help, we’re gonna change the world!
		...
		noDingOn = true
		talkover=true
		fires=[{entity="@transition_script",input="runscriptcode",parameter="TransitionReady()",delay=0.00}]
		}
	/*	
		// [sigh] Caroline, has it really come to this?
		SceneTable ["-1975_03" ] <-
...
if (curMapName=="sp_a3_speed_flings")
	{
		...
		SceneTable ["-1978_01" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_test_b_complete02.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = null
...
if (curMapName=="sp_a3_portal_intro")
	{
		...
		// Once you’ve gathered your things, grab a compensation voucher, good for 60 dollars worth of stuff from the Aperture Science gift shop. Please only touch items you plan on purchasing.
		SceneTable ["-1979_03" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_outro03.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1979_04"
		...
		// Thanks to the IRS and our patent-stealing competitors, there are parking meters in Duluth that earn more money than we do lately. So there’s no room in the budget to wash coffee mugs that you pick up and then decide not to buy.
		SceneTable ["-1979_04" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_outro04.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = "-1979_05"
		...
		SceneTable ["-1979_05" ] <-
		{
		vcd = CreateSceneEntity("scenes/npc/cavejohnson/seventies_outro05.vcd") 
		char = "cave"
		postdelay = 0.0
		predelay = 0.0
		next = null
