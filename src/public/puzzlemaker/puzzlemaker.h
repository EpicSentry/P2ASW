...
//-----------------------------------------------------------------------------
//abstract_class PUZZLEMAKER_CLASS_EXPORT 
class IPuzzleMaker
{
public:

	friend class CPuzzleMaker;
	...
	virtual void Connect(	IFileSystem *_g_pFullFileSystem, IVEngineClient *_engine, IMaterialSystem *_materials, CGlobalVarsBase *_gpGlobals,
							...
							vgui::ISurface *_g_pVGuiSurface, vgui::IInput *_g_pVGuiInput, vgui::ILocalize *_g_pVGuiLocalize,
	...
	virtual float TestTest(int a, float b) = 0; // testing the dylob loads
};
