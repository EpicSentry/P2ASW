...
//	{
	//HACKHACK: Set to true because env_projectedtextures turn off when viewed from a portal.
	//The entity checks if the player is close, but since he's viewing it from a portal he isn't physically
	//near it, but he can still see it.
	//TODO: Find a better way of doing this. -danielmm8888
//#pragma warning "all projected textures are enabled even if not in view. FIX"
		return true;
//	}
