...
CPortal2_VGUI_Ingame_Panel_Manager g_IngamePanelManager;

CPortal2_VGUI_Ingame_Panel::CPortal2_VGUI_Ingame_Panel() //vgui::Panel *pParent, const char *pElementName)
...
CPortal2_VGUI_Ingame_Panel::~CPortal2_VGUI_Ingame_Panel()
{
	g_IngamePanelManager.RemovePanel(this);
}

bool CPortal2_VGUI_Ingame_Panel::MouseClick(int x, int y, bool bRightClick, bool bDown)
{
...
void CPortal2_VGUI_Ingame_Panel_Manager::AddPanel(CPortal2_VGUI_Ingame_Panel *pPanel)
{
...
void CPortal2_VGUI_Ingame_Panel_Manager::RemovePanel(CPortal2_VGUI_Ingame_Panel *pPanel)
{
...
void CPortal2_VGUI_Ingame_Panel_Manager::MovePanelToTop(CPortal2_VGUI_Ingame_Panel *pPanel)
{
	if (!pPanel)
	{
...
void CPortal2_VGUI_Ingame_Panel_Manager::UpdateMouseOvers()
{
	...
	{
		CPortal2_VGUI_Ingame_Panel* pPanel = m_IngamePanelList.Element(i);
		if (pPanel)
		{
			if (!bFoundTopPanel)
			{
...
bool CPortal2_VGUI_Ingame_Panel_Manager::SendMouseClick(bool bRightClick, bool bDown)
{		
	int current_posx, current_posy;
	vgui::input()->GetCursorPos(current_posx, current_posy);
...
bool CPortal2_VGUI_Ingame_Panel_Manager::IngamePanelVisible(vgui::Panel* pPanel)
{
