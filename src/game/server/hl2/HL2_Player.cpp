...
#else
	CTraceFilterSkipTwoEntities filter( this, GetPlayerHeldEntity( this ), COLLISION_GROUP_INTERACTIVE_DEBRIS );
#endif
...
#else
		if ( GetPlayerHeldEntity( this ) == pWeapon && 
			Weapon_OwnsThisType( pWeapon->GetClassname(), pWeapon->GetSubType()) )
#endif
		{
			return true;
...
#else
	return GetPlayerHeldEntity( this );
#endif
}
