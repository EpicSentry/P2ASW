...
void CAI_BaseNPC::AddActivityToSR(const char *actName, int actID)
{
	...
	// technically order isn't dependent, but it's too damn easy to forget to add new ADD_ACTIVITY_TO_SR( ACT_'s to all three lists.
...
{
	ADD_ACTIVITY_TO_SR(ACT_INVALID); 			// So we have something more succint to check for than '-1'
	...
	ADD_ACTIVITY_TO_SR(ACT_COVER); 					// FIXME: obsolete?
	ADD_ACTIVITY_TO_SR(ACT_COVER_MED); 				// FIXME: unsupported?
	ADD_ACTIVITY_TO_SR(ACT_COVER_LOW); 				// FIXME: rename
